...
class ClientsApi(object):
    ...
    def get_client(self, client_id, **kwargs):  # noqa: E501
        ...
        Returns the details of a client.  # noqa: E501
    ...
    def get_client_list(self, **kwargs):  # noqa: E501
        """List all clients  # noqa: E501

        Returns a list of all clients. The clients are returned sorted by creation date, with the newest clients appearing first. Warning: the endpoint is being deprecated and will be removed in future versions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_client_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_client_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_client_list_with_http_info(self, **kwargs):  # noqa: E501
        """List all clients  # noqa: E501

        Returns a list of all clients. The clients are returned sorted by creation date, with the newest clients appearing first. Warning: the endpoint is being deprecated and will be removed in future versions.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_client_list_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def verify_client(self, **kwargs):  # noqa: E501
        """Verify a client  # noqa: E501

        Verifies the client in the provided token  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.verify_client(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ClientsVerifyBody body: Parameters.
        :return: Client
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.verify_client_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.verify_client_with_http_info(**kwargs)  # noqa: E501
            return data

    def verify_client_with_http_info(self, **kwargs):  # noqa: E501
        """Verify a client  # noqa: E501

        Verifies the client in the provided token  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.verify_client_with_http_info(async_req=True)
        >>> result = thread.get()
